...
public static class ChampionshipPlan implements Attribute<com.ashihara.datamanagement.pojo.ChampionshipPlan> { 

	private String parentPath;

	public ChampionshipPlan(){ this(null);}
	public ChampionshipPlan(String parentPath){ super(); this.parentPath = parentPath;}

	@Override
	public String getAttributePath() { return parentPath == null ? getAttributeName() : parentPath;}
	@Override
	public String getAttributeName() { return parentPath == null ? "ChampionshipPlan" : parentPath.substring(parentPath.lastIndexOf(".") + 1); }

	public Championship getChampionship() {return new Championship(this.getAttributePath()+".championship"); }
	public Attribute<Long> getId() {return new Attribute<Long>() {@Override
	public String getAttributePath(){return ChampionshipPlan.this.getAttributePath()+"."+getAttributeName();}@Override
	public String getAttributeName(){return "id";}}; }
	public Attribute<String> getLastModifiedUserId() {return new Attribute<String>() {@Override
	public String getAttributePath(){return ChampionshipPlan.this.getAttributePath()+"."+getAttributeName();}@Override
	public String getAttributeName(){return "lastModifiedUserId";}}; }
...
public static class Fighter implements Attribute<com.ashihara.datamanagement.pojo.Fighter> { 
	...
	public Attribute<Integer> getParticipanceInChampionshipsCount() {return new Attribute<Integer>() {@Override
	public String getAttributePath(){return Fighter.this.getAttributePath()+"."+getAttributeName();}@Override
	public String getAttributeName(){return "participanceInChampionshipsCount";}}; }
...
public static class FightResult implements Attribute<com.ashihara.datamanagement.pojo.FightResult> { 
	...
	public Attribute<Boolean> getFirstFighterWinByTKO() {return new Attribute<Boolean>() {@Override
	public String getAttributePath(){return FightResult.this.getAttributePath()+"."+getAttributeName();}@Override
	public String getAttributeName(){return "firstFighterWinByTKO";}}; }
	public Attribute<Boolean> getSecondFighterWinByTKO() {return new Attribute<Boolean>() {@Override
	public String getAttributePath(){return FightResult.this.getAttributePath()+"."+getAttributeName();}@Override
	...
	public Attribute<Boolean> getFirstFighterWinByJudgeDecision() {return new Attribute<Boolean>() {@Override
	public String getAttributePath(){return FightResult.this.getAttributePath()+"."+getAttributeName();}@Override
	public String getAttributeName(){return "firstFighterWinByJudgeDecision";}}; }
	public Attribute<Boolean> getSecondFighterWinByJudgeDecision() {return new Attribute<Boolean>() {@Override
	public String getAttributePath(){return FightResult.this.getAttributePath()+"."+getAttributeName();}@Override
...
public static class FightingGroup implements Attribute<com.ashihara.datamanagement.pojo.FightingGroup> { 
	...
	public ChampionshipPlan getPlan() {return new ChampionshipPlan(this.getAttributePath()+".plan"); }
	...
	public String getAttributePath(){return FightingGroup.this.getAttributePath()+"."+getAttributeName();}@Override
	public String getAttributeName(){return "tatami";}}; }
	public Attribute<Integer> getOrderInPlan() {return new Attribute<Integer>() {@Override
	public String getAttributePath(){return FightingGroup.this.getAttributePath()+"."+getAttributeName();}@Override
	public String getAttributeName(){return "orderInPlan";}}; }
	public Attribute<Long> getId() {return new Attribute<Long>() {@Override
	public String getAttributePath(){return FightingGroup.this.getAttributePath()+"."+getAttributeName();}@Override
	public String getAttributeName(){return "id";}}; }
	public Attribute<String> getLastModifiedUserId() {return new Attribute<String>() {@Override
...
public static class FighterPlace implements Attribute<com.ashihara.datamanagement.pojo.wraper.FighterPlace> { 
	...
	public Attribute<Long> getWonByJudgeDecisionCount() {return new Attribute<Long>() {@Override
	...
	public Attribute<Long> getWonByTKOCount() {return new Attribute<Long>() {@Override
	public String getAttributePath(){return FighterPlace.this.getAttributePath()+"."+getAttributeName();}@Override
...
public static class FightResultForPlan implements Attribute<com.ashihara.datamanagement.pojo.wraper.FightResultForPlan> { 

	private String parentPath;

	public FightResultForPlan(){ this(null);}
	public FightResultForPlan(String parentPath){ super(); this.parentPath = parentPath;}

	@Override
	public String getAttributePath() { return parentPath == null ? getAttributeName() : parentPath;}
	@Override
	public String getAttributeName() { return parentPath == null ? "FightResultForPlan" : parentPath.substring(parentPath.lastIndexOf(".") + 1); }

	public Attribute<Long> getFirstFighterPointsForWin() {return new Attribute<Long>() {@Override
	public String getAttributePath(){return FightResultForPlan.this.getAttributePath()+"."+getAttributeName();}@Override
	public String getAttributeName(){return "firstFighterPointsForWin";}}; }
	public Attribute<Long> getSecondFighterPointsForWin() {return new Attribute<Long>() {@Override
	public String getAttributePath(){return FightResultForPlan.this.getAttributePath()+"."+getAttributeName();}@Override
	public String getAttributeName(){return "secondFighterPointsForWin";}}; }
	...
	public GroupChampionshipFighter getSecondFighter() {return new GroupChampionshipFighter(this.getAttributePath()+".secondFighter"); }
	public FightingGroup getFightingGroup() {return new FightingGroup(this.getAttributePath()+".fightingGroup"); }
	public FightResult getFightResult() {return new FightResult(this.getAttributePath()+".fightResult"); }
	public Attribute<Integer> getNumberInPlan() {return new Attribute<Integer>() {@Override
	public String getAttributePath(){return FightResultForPlan.this.getAttributePath()+"."+getAttributeName();}@Override
	public String getAttributeName(){return "numberInPlan";}}; }
} 
